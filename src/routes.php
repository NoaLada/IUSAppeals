...
$app->get('/api/conf/{id}/{key}', function ($request, $response, $args) {
...
function get_mail_content($data) {
    ...
    $content = "<p>Dear ".$data['name'].",</p>".
                ...
                "<p>http://localhost:8888/api/appeals/pdf/".$appeal_id."</p>".
...
function generate_confirmation_link($signature_id, $user_id, $appeal_id, $sperson_id, $user_salt) {
    ...
    return "http://localhost:8888/api/conf/".$signature_id."/".$hash;
}
